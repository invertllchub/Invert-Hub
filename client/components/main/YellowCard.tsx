...
function YellowCard({h1, p, link, img, alt}: YellowCardProps) {
    return (
        ...
        >
            <div className="w-full md:w-8/12 h-6/12 md:h-full flex flex-col justify-between text-start p-2 gap-4">
                {h1 && 
            ...
            <div className="relative w-full md:w-4/12 h-6/12 md:h-full rounded-md overflow-hidden">
                <Image
                alt={alt}
                src={img}
                fill
