...
export default function CombinedPage() {
  ...
  <section className="w-full py-10 md:py-16 text-start">
    <h2 className="text-2xl sm:text-3xl md:text-5xl font-semibold text-black px-4 md:px-16">
      We’ve always thrived on thinking differently — because that’s where true progress lies. 
      We look beyond architecture. We explore limitless ideas. We discover unseen potential. 
      We are UNS, we see what others miss.
    </h2>
    <div className="w-full text-start px-4 md:px-16 mt-6 md:mt-10">
      <div className="w-full md:w-6/12 md:ml-auto">
        <p className="text-lg md:text-xl font-semibold text-gray-700">
          The best ideas are born from collaboration. With seven offices spanning four continents,
          our dedicated teams are not afraid to challenge themselves, our clients and
          our collaborators to go beyond the predictable. In this quest, we uncover
          hidden opportunities to transform the built environment all around the world.
        </p>
        <h1 className="text-lg md:text-xl font-semibold mt-4 md:mt-10">ABOUT US</h1>
      </div>
    </div>
  </section>
  ...
  <section className="w-full min-h-[100vh]  flex flex-col items-center justify-center gap-6 px-4 py-12">
    <h1 className="text-sm sm:text-base md:text-lg font-semibold">OUR PROJECTS</h1>
        ...
        <div className="wrapper h-full relative flex flex-col gap-[20vh] items-center p-1">
          {verticalItems.map((item, index, arr) => (
            ...
            >
              ...
              <div className="item_content relative flex flex-col justify-center text-center 
                md:text-start bg-white text-[#292929] p-6 sm:p-12 sm:w-1/2 w-full h-[40vh] sm:h-full">
                <h2 className="text-sm md:text-lg font-bold mb-2">{item.title}</h2>
                <p className="text-2xl sm:text-5xl md:text-7xl font-bold">{item.desc}</p>
                <div className="w-full h-10 flex items-center justify-between absolute bottom-0 left-0 p-6">
                  <p>{`${String(index + 1).padStart(2, "0")} / ${String(arr.length).padStart(2, "0")}`}</p>
                  <p className="text-base sm:text-lg font-semibold underline underline-offset-8">ALL PROJECTS</p>
                </div>
              </div>
            </div>
          ))}
  ...
  <section className="yellow w-full bg-[#f6f6f6] text-black p-6 sm:p-10 md:p-16 mt-12">
    ...
    <h2 className="text-xl sm:text-3xl md:text-5xl font-semibold mt-6">
      Our studio is fueled by a passion to question and provoke. Our melting pot of expertises
      leads to interwoven design and consultancy solutions that deliver beyond the brief.
    </h2>
    <p className="text-lg md:text-xl font-semibold underline underline-offset-8 mt-16">OUR SERVICES</p>
    ...
    <div className="w-full mt-12 space-y-10">
      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-6">
        <h1 className="text-2xl sm:text-4xl md:text-5xl font-semibold">Design</h1>
        <div className="w-full md:w-6/12">
          <p className="text-lg sm:text-xl md:text-2xl font-semibold">Delivering transformative design solutions across all scales and disciplines.</p>
          <p className="text-lg md:text-xl font-semibold underline underline-offset-8 mt-10">FIND OUT MORE</p>
        </div>
      </div>
      <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-6">
        <h1 className="text-2xl sm:text-4xl md:text-5xl font-semibold">Consulting</h1>
        <div className="w-full md:w-6/12">
          <p className="text-lg sm:text-xl md:text-2xl font-semibold">Unlocking new possibilities in sustainability, economics, technology, and health</p>
          <p className="text-lg md:text-xl font-semibold underline underline-offset-8 mt-10">FIND OUT MORE</p>
        </div>
      </div>
    </div>
  ...
  <section className="yellow w-full bg-black text-white p-6 sm:p-10 md:p-16 mt-10">
    <h1 className="text-3xl sm:text-5xl md:text-[88px] font-[900] ">RESEARCH AND <br /> INNOVATION</h1>
    <h2 className="text-xl sm:text-3xl md:text-5xl font-semibold mt-6">
      We see no reason to limit our ambition. We always ask ourselves, this and..?
      What can we do next and how can we offer greater value? Our expanding
      capabilities and Research & Innovation teams set us up to grow beyond architecture. And then some.
    </h2>
    <p className="sm:text-lg md:text-xl font-semibold underline underline-offset-8 mt-16">FIND OUT MORE</p>
    <div className="relative mt-10 w-full object-cover h-[400px] md:h-[800px] rounded-md overflow-hidden">
      <Image 
        alt=""
        src="/pic7.webp"
  ...
  <section className="yellow w-full bg-[#f6f6f6] text-black mt-10">
    <div className="p-6 sm:p-10 md:p-14">
      <h1 className="font-sans text-3xl sm:text-5xl md:text-[88px] font-[900]">JOIN THE TEAM</h1>
      <h2 className="text-xl sm:text-3xl md:text-5xl font-semibold mt-6">
        Join us on a journey where perspective is everything and where the usual angles are just the starting point.
      </h2>
      <p className="sm:text-lg md:text-xl font-semibold underline underline-offset-8 mt-6">CAREERS</p>
    </div>
  ...
  <section className="yellow w-full h-[100vh] bg-[#f6f6f6] text-black p-6 md:p-16">
    <div className="w-full h-full flex flex-col lg:flex-row items-center justify-between gap-8 mt-10 py-10 px-4 
    bg-gradient-to-r from-yellow-200/70 to-yellow-100 rounded-lg">
      <div className="w-full md:w-8/12 h-full flex flex-col justify-between text-start p-4">
        ...
        <p className="sm:text-lg md:text-xl font-semibold underline underline-offset-8 mt-6">GET IN TOUCH</p>
      </div>
